...
14 | Merged Internal PRs: <ul><li>[[MarkBind#1215] Make highlighting effective for code-formatted text](https://github.com/MarkBind/markbind/pull/1215)</li></ul> Merged External PRs: <ul><li>[[Moment#5356] [locale] add support for zh-mo](https://github.com/moment/moment/pull/5356)</li></ul> Reviewed external PRs: <ul><li>[[Moment#4695] [locale] zh: align relativeTime.future to CLDR 33](https://github.com/moment/moment/pull/4695)</li></ul> Investigated issues: <ul><li>[[MarkBind#981] Request to rebrand vuestrap as an independent npm package under MarkBind org](https://github.com/MarkBind/markbind/issues/981#)</li><li>[[MarkBind#1161] Link to DevGuide in markbind.org](https://github.com/MarkBind/markbind/issues/1161)</li><li>[[MarkBind#1210] Make highlighting effective for code-formatted text](https://github.com/MarkBind/markbind/issues/1210)</li></ul>
